...
The dashboard is live at **[binomial-tree-pricer.vercel.app](https://binomial-tree-pricer.vercel.app)**
— no setup required. It prices an at-the-money 1-year call on load; adjust the
inputs in the left panel and click **Price option** to re-price and redraw
everything.

### Running locally (optional)

Only needed if you want to modify the code. From a PowerShell prompt in this
folder:
